...
{
    [AllowAnonymous]
    public class LoginBackofficeModel : PageModel
    {
        private readonly SignInManager<ApplicationUser> _signInManager;
        private readonly ILogger<LoginBackofficeModel> _logger;
        private readonly UserManager<ApplicationUser> _userManager;

        public LoginBackofficeModel(SignInManager<ApplicationUser> signInManager, ILogger<LoginBackofficeModel> logger,
